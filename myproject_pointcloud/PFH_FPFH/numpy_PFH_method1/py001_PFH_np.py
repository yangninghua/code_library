...
from pfh import PFH, SPFH, FPFH

if __name__=='__main__':
    # Import the data
    source_pc = utils.load_pc_np('PFH_FPFH/numpy_PFH_method1/plant_source.npy')
    target_pc = utils.load_pc_np('PFH_FPFH/numpy_PFH_method1/plant_target3.npy')
